...
#แต่ละ HTTP method ใน API หมายความว่าอะไรบ้าง? ทำไมไม่ใช้ POST อย่างเดียว?
...
*answer:* ในไฟล์ index.js เราใส่มันไว้บรรทัดแรกสุดก่อน middleware และ routes ทุกตัว:
